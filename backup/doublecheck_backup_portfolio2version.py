...
def reset_filters():
    ...
    filter_keys = ["registry_sel", "region_sel", "country_sel", "scope_sel", "type_sel", "redrem_sel", "master_all"]
    for key in filter_keys:
        if key in st.session_state:
            # Use safe_update_session_state to clear the values instead of deleting
            if key.endswith("_sel"):
                safe_update_session_state(key, [])
            else:
                safe_update_session_state(key, False)
    st.rerun()
