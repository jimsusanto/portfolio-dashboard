...
<style>
    /* Custom styles for Streamlit + Tailwind */
    .main-header {
...
<div class="main-header">
    <h1 class="text-3xl md:text-4xl font-bold">Carbon Project Analysis Dashboard</h1>
    <p class="text-lg mt-2 opacity-90">Interactive visualization of carbon credit projects worldwide</p>
</div>
""", unsafe_allow_html=True)
...
<div class="sidebar-header">
    ...
    <p class="text-sm opacity-75">Customize your view</p>
</div>
""", unsafe_allow_html=True)
...
<div class="section-title">
    <h3 class="text-xl font-bold">List of Projects</h3>
    <p class="text-sm opacity-75">Filtered view of carbon credit projects</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Credits by Reduction/Removal (Filtered)</h3>
    <p class="text-sm opacity-75">Distribution of carbon credits by type</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Projects by Reduction/Removal by Standard</h3>
    <p class="text-sm opacity-75">Cross-analysis of projects by registry and type</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Projects by Scope</h3>
    <p class="text-sm opacity-75">Distribution of projects by their scope categories</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Projects by Scope by Standard</h3>
    <p class="text-sm opacity-75">Multi-level analysis of projects by registry, scope, and type</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Distribution of Projects Across Countries</h3>
    <p class="text-sm opacity-75">Geographic distribution of carbon credit projects</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Distribution of Projects Across Countries by Standard</h3>
    <p class="text-sm opacity-75">Geographic distribution by voluntary registry</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Project Starts by Standard Over Time (by First Vintage Year)</h3>
    <p class="text-sm opacity-75">Timeline of project initiations by registry</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("""
<div class="section-title">
    <h3 class="text-xl font-bold">Top 20 Countries with Most Projects (Stacked by Registry)</h3>
    <p class="text-sm opacity-75">Leading countries in carbon credit project development</p>
</div>
""", unsafe_allow_html=True)
